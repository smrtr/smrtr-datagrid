...
class DataGridVector implements \Countable, \ArrayAccess, \Iterator
{
    ...
    /**
     * Exactly one key must be provided.
     *
     * $rowkey parameter takes precedence if you try to provide two keys.
     *
     * @param int $DataGridID Link this object to a DataGrid with $DataGridID
     * @param bool|int $rowKey Optional; Save the position of this vector with a rowKey
     * @param bool|int $columnKey Optional; Save the position of this vector with a columnKey
     *
     * @throws \Exception
     */
     ...
     *
     * @param bool $labelled
     * False by default; if true then returned array indexed by labels, if they are found.
     *
     * @return array
     */
     ...
     * @return array
     */
    public function getValues($labelled=false)
    {
